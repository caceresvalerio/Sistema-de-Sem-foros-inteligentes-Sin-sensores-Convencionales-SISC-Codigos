...
import ado.edu.pucmm.trafficlightcontroller.rest.Parser;
import ado.edu.pucmm.trafficlightcontroller.rest.RestHandler;
import ado.edu.pucmm.trafficlightcontroller.utils.HttpUtils;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void sendLocation(Location location) {
        ...
        parameters.put("code", ViewUtilities.serverIp);
    ...
    private void handleIntent(Intent intent) {
        try {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(getApplicationContext(), "El NFC Tag ha sido removido", Toast.LENGTH_LONG).show();
                    ...
                    ViewUtilities.startActivity(MapsActivity.this, MainActivity.class);
